...
$(function(){
 ...
 //             str+="<li><a href='javascript:void(0)''>"+res.clinic_info.popular_diseases[i].name+"</a></li>"
 //           }
 //           $(".box-item").html(str)
 //        }
	// })
    var res={
       ...
       "show_download_bar":true,
	    ...
	    "health_news":[
	        ...
	        {
	            "favor_num":2,
	            "img":"https://media2.chunyuyisheng.com/@/media/images/2017/11/22/fa9e/d35736987b0d_w180_h150_.jpg?imageView2/1/w/120/h/116",
	            "title":"肉松洗出棉花絮状物？谣言换了个马甲又来了",
	            "date_str":"6小时前",
	            "image":"https://media2.chunyuyisheng.com/@/media/images/2017/11/22/fa9e/d35736987b0d_w180_h150_.jpg?imageView2/1/w/120/h/116",
	            "news_id":114099,
	            "channel_id":18,
	            "view_times":2405,
	            "type":"news",
	        ...
	        {
	            "description":"",
	            "title":"糖妈妈产后还需要继续糖尿病饮食吗？",
	            "url":"https://media2.chunyuyisheng.com/@/media/video/99ce33d1vodtransgzp1252638726/b6f6e5a64564972818442023264/v.f20.mp4",
	            "type":"video_segment",
	            "image":"https://media2.chunyuyisheng.com/@/media/images/2017/11/16/2334/c2aee9e6089a_w767_h675_.png",
	            "lecture_status":"已结束",
	            "play_count":0,
	            "seconds":"03:25",
	            "room_id":434,
       ...
       "show_logo":true,
	    ...
	    "hot_problems":[
	        {
	            "ask":"您好，我父亲从上周日晚上开始有发烧症状，但是自己发汗后体温会降下去，上周一到现在胃疼，用电子测...",
	            "answer":"您好！以前有胃病史吗？",
	            "title":"但是自己发汗后体温会降下去，上周一到现在胃疼，怎么办？",
	            "id":"cwnCtU_2Ja8AqwXAdWORrQ",
	            "doctor":{
	                "hospital":"北京协和医院",
	                "name":"舒慧君"
	            }
	        ...
	        {
	            "ask":"狂犬病潜伏期最长多久（男，19岁）",
	            "answer":"狂犬病潜伏期及早期症状:潜伏期长短不一，大多数在3个月内发病。最长可达10年以上。潜伏期长短与...",
	            "title":"狂犬病潜伏期最长多久，怎么办？",
	            "id":"lXCkTVaMUV_QfcNESyQhaw",
	            "doctor":{
	                "hospital":"泗县中医院",
	                "name":"魏本余"
	            }
       ...
       "is_login":false
    	  ...
    	  var str="";
           ...
           for(var j=0;j<res.health_news.length;j++){
             hStr+="<div class='tip-div clearfix'><img src='./images/7.jpg' alt=''><div class='tip-con clearfix'><h6>"+res.health_news[j].title+"</h6><p><span>"+res.health_news[j].channel_name+"</span><span class='time'>"+res.health_news[j].date_str+"</span></p></div></div>"
           }
           $(".div").html(hStr);
           var qStr="";
           for(var k=0;k<res.hot_problems.length;k++){
           	 qStr+="<li class='item'><h6 class='item-title'><span>问</span>"+res.hot_problems[k].title+"</h6><p>"+res.hot_problems[k].ask+"</p></li>"
           }
           $(".home>ul").html(qStr);

})
 $(function(){
 	// var a = [5,1,1,2,2,3,4,4,5];
  //       var b = [];
  ...
  //       }
  //       console.log(b);
 	// var a=[1,1,1,1,2,3,2,3,4,5,6,5,7];
 	// function compare(value2,value1){
